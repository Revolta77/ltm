...
(function ($) {
    ...
    function updateTranslationFromXEditable() {
        ...
        $.fn.OldScriptHooks.GLOBAL_TRANSLATION_CHANGED(group, key, locale, value, (status) => {
            ...
            var trans = elemRow.find('a.revolta77_editable'), tmp;
    ...
    $.fn.revolta77_editable = function (options) {
        var defaults = {},
        ...
        this.each(function () {
            ...
            elem.editable().off('hidden');
            elem.editable().on('hidden.revolta77', function (e, reason) {
                if (reason === 'save') {
            ...
            elem.editable().off('shown');
            elem.editable().on('shown.revolta77', function (e, editable) {
                if (!$(this).hasClass('revolta77_editable')) {
                    return;
                }
    ...
    $.fn.revolta77_editable.updateTranslationFromXEditable = updateTranslationFromXEditable;
