...
(function ($) {
    ...
    $.fn.OldScriptHooks.HOOKUP_TRANSLATION_PAGE_EVENTS = function () {
        ...
        $form_keyops.on('ajax:success', function (e, data) {
            ...
            elem.html(data);
            elem.find('.revolta77_editable').revolta77_editable();
        });
                        ...
                        var jqxhr = $.ajax({
                            ...
                            success: function (json) {
                                if (json.status === 'ok') {
                                    ...
                                    $.fn.revolta77_editable.updateTranslationFromXEditable.call(t.dstElem);
        ...
        elemAutoTrans.each(function () {
            ...
            btnElem.on('click', function (e) {
                ...
                $(".auto-translatable-" + dstLoc).each(function () {
                    var row = $(this).parent().find('.revolta77_editable');
                    if (row.length > 1) {
                        var srcElem = $(row[0]),
                            dstElem = $(row[colNum]),
                            tr = row.closest('tr');
        ...
        elemAutoFill.on('click', function (e) {
            ...
            $(".auto-fillable").each(function () {
                var dstElem = $(this).find("a.revolta77_editable.editable-empty"),
            ...
            btnElem.on('click', function (e) {
                ...
                $(".auto-translatable-" + dstLoc).each(function () {
                    ...
                    if (!row.hasClass('hidden')) {
                        var editable = $(this).parent().find('.revolta77_editable');
