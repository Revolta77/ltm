            ...
            <table class="table table-striped item-index table-condensed">
                ...
                <tbody>
                    <tr class="form-group-xs">
                        ...
                        <td>{!! Form::text('user', Input::get('user'), ['form' => 'filter-userlocales', 'data-revolta77_completion'=>'users:id;id:user_id','class'=>'form-control', 'placeholder'=>noEditTrans('ltm-user-locales.user_id'), ]) !!}
