...
namespace Revolta77\TranslationManager\Classes;
...
class PathTemplateResolver
{
    ...
    protected function loadFileList($prefix, $path_parts, $group_parts)
    {
        ...
        for (; ;) {
            $isUnderBaseDir = $prefix == $this->normalized_base_path || \Illuminate\Support\StrStr::startsWith($prefix . '/', $this->normalized_base_path . '/');
