...
use Revolta77\TranslationManager\Classes\TranslationLocales;
...
class Controller extends BaseController
{
    ...
    {
        $this->package = \Revolta77\TranslationManager\ManagerServiceProvider::PACKAGE;
    ...
    {
        Route::get('view/{group?}', '\\Revolta77\\TranslationManager\\Controller@getView');

        //deprecated: Route::controller('admin/translations', '\\Revolta77\\TranslationManager\\Controller');
        Route::get('/', '\\Revolta77\\TranslationManager\\Controller@getIndex');
        Route::get('connection', '\\Revolta77\\TranslationManager\\Controller@getConnection');
        Route::get('index', '\\Revolta77\\TranslationManager\\Controller@getIndex');
        Route::get('interface_locale', '\\Revolta77\\TranslationManager\\Controller@getTranslationLocales');
        Route::get('keyop/{group}/{op?}', '\\Revolta77\\TranslationManager\\Controller@getKeyop');
        Route::get('search', '\\Revolta77\\TranslationManager\\Controller@getSearch');
        Route::get('toggle_in_place_edit', '\\Revolta77\\TranslationManager\\Controller@getToggleInPlaceEdit');
        Route::get('toggle_show_unpublished', '\\Revolta77\\TranslationManager\\Controller@getToggleShowUnpublished');
        Route::get('translation', '\\Revolta77\\TranslationManager\\Controller@getTranslation');
        Route::get('usage_info', '\\Revolta77\\TranslationManager\\Controller@getUsageInfo');
        Route::get('view/{group?}', '\\Revolta77\\TranslationManager\\Controller@getView');
        ...
        Route::post('delete/{group}/{key}', '\\Revolta77\\TranslationManager\\Controller@postDelete');
        Route::post('delete_all/{group}', '\\Revolta77\\TranslationManager\\Controller@postDeleteAll');
        Route::post('publish/{group}', '\\Revolta77\\TranslationManager\\Controller@postPublish');
        Route::post('import/{group}', '\\Revolta77\\TranslationManager\\Controller@postImport');
        Route::get('zipped_translations/{group?}', '\\Revolta77\\TranslationManager\\Controller@getZippedTranslations');
        Route::get('publish/{group}', '\\Revolta77\\TranslationManager\\Controller@getPublish');
        Route::get('import', '\\Revolta77\\TranslationManager\\Controller@getImport');

        // shared web and api urls 
        // TODO: migrate to Rest Controller for implementation
        Route::post('edit/{group}', '\\Revolta77\\TranslationManager\\Controller@postEdit');
        Route::post('undelete/{group}/{key}', '\\Revolta77\\TranslationManager\\Controller@postUndelete');
        Route::post('user_locales', '\\Revolta77\\TranslationManager\\Controller@postUserLocales');

        // TODO: implement a json api for wild-card key ops
        Route::post('delete_keys/{group}', '\\Revolta77\\TranslationManager\\Controller@postDeleteKeys');
        Route::post('copy_keys/{group}', '\\Revolta77\\TranslationManager\\Controller@postCopyKeys');
        Route::post('move_keys/{group}', '\\Revolta77\\TranslationManager\\Controller@postMoveKeys');
        Route::post('preview_keys/{group}', '\\Revolta77\\TranslationManager\\Controller@postPreviewKeys');
    }
    ...
    public static function apiRoutes($disableReactUI)
    {
        ...
        if (!$disableReactUI) {
            Route::get('ui', '\\Revolta77\\TranslationManager\\Controller@getUI');
            Route::get('ui/{all?}', '\\Revolta77\\TranslationManager\\Controller@getUI')->where('all', '.*');

            Route::get('api/app-settings', '\\Revolta77\\TranslationManager\\Controller@getAppSettings');
            Route::post('api/app-settings', '\\Revolta77\\TranslationManager\\Controller@postAppSettings');

            Route::get('api/translations/{group}/{locale}', '\\Revolta77\\TranslationManager\\Controller@getTranslations');
            Route::post('api/search', '\\Revolta77\\TranslationManager\\Controller@apiSearch');
            Route::post('api/summary', '\\Revolta77\\TranslationManager\\Controller@apiSummary');
            Route::post('api/translation-table/{group}', '\\Revolta77\\TranslationManager\\Controller@apiTranslationTable');
            Route::post('api/user-list', '\\Revolta77\\TranslationManager\\Controller@apiUserList');
            Route::post('api/mismatches', '\\Revolta77\\TranslationManager\\Controller@apiMismatches');

            Route::post('api/delete-suffixed-keys/{group}', '\\Revolta77\\TranslationManager\\Controller@apiDeleteSuffixedKeys');
            Route::post('api/add-suffixed-keys/{group}', '\\Revolta77\\TranslationManager\\Controller@apiAddSuffixedKeys');
            Route::post('api/key-references/{group}/{key?}', '\\Revolta77\\TranslationManager\\Controller@apiKeyReferences');
            Route::post('api/delete-group/{group}', '\\Revolta77\\TranslationManager\\Controller@apiDeleteGroup');
            Route::post('api/find-references', '\\Revolta77\\TranslationManager\\Controller@apiFindReferences');
            Route::post('api/clear-ui-settings', '\\Revolta77\\TranslationManager\\Controller@postClearUISettings');

            Route::post('api/publish-group/{group}', '\\Revolta77\\TranslationManager\\Controller@apiPublishGroup');
            Route::post('api/import-group/{group}', '\\Revolta77\\TranslationManager\\Controller@apiImportGroup');
            Route::get('api/zipped-translations/{group?}', '\\Revolta77\\TranslationManager\\Controller@apiZippedTranslations');

            // TODO: convert to Rest API
            Route::get('api/app-settings-json', '\\Revolta77\\TranslationManager\\Controller@getAppSettingsJson');
            Route::post('api/missing-keys', '\\Revolta77\\TranslationManager\\Controller@postMissingKeys');

            Route::post('api/trans-filters', '\\Revolta77\\TranslationManager\\Controller@apiTransFilters');

            // shared web and api urls 
            // TODO: migrate to Rest Controller for implementation
            Route::post('api/delete/{group}/{key}', '\\Revolta77\\TranslationManager\\Controller@postDelete');
            Route::post('api/edit/{group}', '\\Revolta77\\TranslationManager\\Controller@postEdit');
            Route::post('api/undelete/{group}/{key}', '\\Revolta77\\TranslationManager\\Controller@postUndelete');
            Route::post('api/user_locales', '\\Revolta77\\TranslationManager\\Controller@postUserLocales');
        }
    }
    ...
    public function postMissingKeys()
    {
        ...
        /* @var $translator \Revolta77\TranslationManager\Translator */
        $translator = App::make('translator');
