...
namespace Revolta77\TranslationManager;
...
use Revolta77\TranslationManager\Classes\PathTemplateResolver;
use Revolta77\TranslationManager\Classes\TranslationFileRewriter;
 ...
 * Class Manager
 *
 * @package Revolta77\TranslationManager
 */
class Manager
{
    ...
    /**
     * @return \Revolta77\TranslationManager\Models\Translation
     */
     ...
     *
     * @return \Revolta77\TranslationManager\Models\Translation|null
     */
        ...
        if (!$useLottery || $this->config(self::LOG_MISSING_KEYS_KEY)) {
            ...
            if (!in_array($group, $this->config(self::EXCLUDE_GROUPS_KEY))) {
                ...
                if ($lottery == 1) {
                    ...
                    /* @var $translation \Revolta77\TranslationManager\Models\Translation */
                    return $translation;
                }
            }
        }
