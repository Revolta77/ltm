...
class ManagerServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton(self::PACKAGE, function ($app) {
            /* @var $manager \Revolta77\TranslationManager\Manager */
            $manager = $app->make('Revolta77\TranslationManager\Manager');
            return $manager;
        });
    ...
    public function boot(Router $router)
    {
        ...
        $config['namespace'] = 'Revolta77\TranslationManager';
        ...
        $router->pushMiddlewareToGroup('web', 'Revolta77\TranslationManager\RouteAfterMiddleware');
    }
