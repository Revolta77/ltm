...
* Fix: #119, Call to undefined function Revolta77\TranslationManager\getSupportedLocale().
...
* Add: `Revolta77\\TranslationManager\\Events\\TranslationsPublished` event class with two
  attributes:
